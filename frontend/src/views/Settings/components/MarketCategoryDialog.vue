...
watch(
  ...
  (category) => {
    if (category) {
      formData.value = { ...defaultFormData, ...category, description: category.description || '' }
    } else {
...
watch(
  ...
  (visible) => {
    if (visible) {
      if (props.category) {
        formData.value = { ...defaultFormData, ...props.category, description: props.category.description || '' }
      } else {
        formData.value = { ...defaultFormData }
      }
    }
